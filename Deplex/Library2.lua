		...
		Library.CreateSettingsPage = function(self, Window, KeybindList, Watermark)
			...
			do
				...
				do
					...
					local HideShowGui = Instance.new("ScreenGui")
					HideShowGui.Name = "lol"
					HideShowGui.Parent = game:GetService("CoreGui")

					Library.HideShowButton = Instance.new("ImageButton")
					Library.HideShowButton.Name = "ToggleButton"
					Library.HideShowButton.Parent = HideShowGui
					...
					HideShowCorner.CornerRadius = UDim.new(0, 8)
					HideShowCorner.Parent = Library.HideShowButton
